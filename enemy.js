...
class Enemy {
    ...
    // shows the enemy as a red ellipse
    show() {
        push()
        imageMode(CENTER)
        if (this.direction == 1) {
            image(enemyRight, this.x, this.y, squareSize * 0.5, squareSize * 0.5)
        }
        if (this.direction == -1) {
            image(enemyLeft, this.x, this.y, squareSize * 0.5, squareSize * 0.5)
        }
        if (this.direction == 2) {
            image(enemyUp, this.x, this.y, squareSize * 0.5, squareSize * 0.5)
        }
        if (this.direction == -2) {
            image(enemyDown, this.x, this.y, squareSize * 0.5, squareSize * 0.5)
        }
    ...
    kill() {
        // if the enemy reaches the end, or is off the grid
